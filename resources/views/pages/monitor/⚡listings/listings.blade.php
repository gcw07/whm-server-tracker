        ...
        <flux:dropdown position="bottom" align="end">
          ...
          <flux:menu>
            <flux:menu.radio.group wire:model.live="filterBy">
              ...
              <flux:menu.radio value="on_my_cloudflare">On My Cloudflare Account</flux:menu.radio>
              ...
              <div class="px-6 py-4 flex justify-between items-center border-b border-zinc-800/10 dark:border-white/20 text-sm">
                <div class="flex items-center gap-3">
                  ...
                  @if($this->filterBy === 'on_my_cloudflare')
                    <flux:badge as="button" size="sm" rounded icon:trailing="x-mark" color="sky" wire:click="removeAllFilters">On My Cloudflare Account</flux:badge>
                  @endif
