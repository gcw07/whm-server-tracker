        ...
        <div class="pt-8">
          <flux:card class="p-0 overflow-hidden bg-gray-50">
            ...
            <flux:table :paginate="$this->accounts">
              <flux:table.columns>
                <flux:table.column class="px-6! bg-gray-50 font-medium text-gray-500! text-xs tracking-wide" sortable :sorted="$sortBy === 'name'" :direction="$sortDirection" wire:click="sort('name')">DOMAIN</flux:table.column>
                <flux:table.column class="bg-gray-50 font-medium text-gray-500! text-xs tracking-wide" sortable :sorted="$sortBy === 'accounts'" :direction="$sortDirection" wire:click="sort('accounts')">SERVER</flux:table.column>
...
{{--                      @endif--}}
                    ...
                    <flux:table.cell class="whitespace-nowrap">WP v</flux:table.cell>
                    ...
                    <flux:table.cell class="whitespace-nowrap">{{ $account->formatted_disk_usage }}%</flux:table.cell>
