  ...
  <flux:card class="p-0 overflow-hidden bg-gray-50 mt-8">
    ...
    <flux:table :paginate="$this->accounts" pagination:scroll-to>
      <flux:table.columns>
        ...
        <flux:table.column class="bg-gray-50 font-medium text-gray-500! text-xs tracking-wide" sortable :sorted="$sortBy === 'wordpress'" :direction="$sortDirection" wire:click="sort('wordpress')">WORDPRESS</flux:table.column>
