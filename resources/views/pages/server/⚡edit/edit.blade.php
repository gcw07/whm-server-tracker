<div>
  ...
  <div class="pb-5 border-b border-gray-200 md:flex md:items-center md:justify-between">
    <div class="flex-1 min-w-0">
      <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item>Edit server</flux:breadcrumbs.item>
      </flux:breadcrumbs>
  ...
  <div class="mt-6">
    ...
    <flux:card class="bg-white">
      <flux:heading size="xl">Edit server</flux:heading>
      <flux:subheading>Enter the required information below to edit a server.</flux:subheading>
      ...
      <form wire:submit="save" class="space-y-8">
        ...
        <div class="pt-5 border-t border-gray-200">
          <div class="flex justify-end space-x-3">
            <flux:button :href="route('servers.show', $this->form->server->id)">Cancel</flux:button>
