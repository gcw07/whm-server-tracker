      ...
      <form wire:submit.prevent="save" class="space-y-8 divide-y divide-gray-200">
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          <div>
            ...
            <div class="space-y-6 sm:space-y-5">
              ...
              <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                <label for="token" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Token </label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
        ...
        <div class="pt-5">
          <div class="flex justify-end">
            <a href="{{ route('servers.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">Cancel</a>
