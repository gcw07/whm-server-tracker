        ...
        <div class="flex">
          ...
          <div class="ml-3 flex-1 md:flex md:justify-between">
            <p class="text-sm text-red-700">
              There are {{ $sitesWithIssues }} sites with issues.
            </p>
                  ...
                  <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      <tr>
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"> {{ $serverTypes->dedicated }} </td>
                      </tr>
                      <tr>
                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">Reseller</td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">  {{ $serverTypes->reseller }} </td>
                      </tr>
                      <tr>
                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">VPS</td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">  {{ $serverTypes->vps }} </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
