<x-slot name="actions">
  <button onclick="Livewire.emit('openModal', 'add-user')" type="button"
          class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          ...
          @if ($loop->last)
            <x-table.cell class="flex justify-end rounded-br-lg">
              ...
              <x-dropdown class="relative">
                <x-slot name="trigger">
                  <button type="button"
                          class="max-w-xs rounded flex items-center text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-600 focus:ring-white"
                ...
                <div
                  ...
                  <div class="px-1 py-1">
                    <a href="#"
                       class="flex items-center w-full px-2 py-2 text-sm text-gray-700 rounded hover:bg-gray-200">
