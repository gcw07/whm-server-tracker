module.exports = {
     ...
     */
    post(uri, form) {
        return Laravel.sendForm('post', uri, form);
    },
     ...
     */
    put(uri, form) {
        return Laravel.sendForm('put', uri, form);
    },
     ...
     */
    patch(uri, form) {
        return Laravel.sendForm('patch', uri, form);
    },
     ...
     */
    delete(uri, form) {
        return Laravel.sendForm('delete', uri, form);
    },
